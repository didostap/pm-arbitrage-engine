...
> = {
  ...
  incrementalIngestionCronExpression: {
    group: SettingsGroup.DataQualityStaleness,
    label: 'Incremental Ingestion Cron',
    description:
      'Cron schedule for incremental historical data refresh. Default: daily 2 AM UTC.',
    type: 'string',
    envDefault: CONFIG_DEFAULTS.incrementalIngestionCronExpression.defaultValue,
  },
  incrementalIngestionEnabled: {
    group: SettingsGroup.DataQualityStaleness,
    label: 'Incremental Ingestion Enabled',
    description: 'Enable automated incremental historical data refresh.',
    type: 'boolean',
    envDefault: CONFIG_DEFAULTS.incrementalIngestionEnabled.defaultValue,
  },
  stalenessThresholdPlatformMs: {
    group: SettingsGroup.DataQualityStaleness,
    label: 'Platform Staleness Threshold',
    description:
      'Time before platform API data (Kalshi, Polymarket, Goldsky) is considered stale.',
    type: 'integer',
    envDefault: CONFIG_DEFAULTS.stalenessThresholdPlatformMs.defaultValue,
    min: 3_600_000,
    unit: 'ms',
  },
  stalenessThresholdPmxtMs: {
    group: SettingsGroup.DataQualityStaleness,
    label: 'PMXT Archive Staleness Threshold',
    description: 'Time before PMXT Archive data is considered stale.',
    type: 'integer',
    envDefault: CONFIG_DEFAULTS.stalenessThresholdPmxtMs.defaultValue,
    min: 3_600_000,
    unit: 'ms',
  },
  stalenessThresholdOddspipeMs: {
    group: SettingsGroup.DataQualityStaleness,
    label: 'OddsPipe Staleness Threshold',
    description: 'Time before OddsPipe OHLCV data is considered stale.',
    type: 'integer',
    envDefault: CONFIG_DEFAULTS.stalenessThresholdOddspipeMs.defaultValue,
    min: 3_600_000,
    unit: 'ms',
  },
  stalenessThresholdValidationMs: {
    group: SettingsGroup.DataQualityStaleness,
    label: 'Validation Staleness Threshold',
    description:
      'Time before match validation data (OddsPipe/Predexon pairs) is considered stale.',
    type: 'integer',
    envDefault: CONFIG_DEFAULTS.stalenessThresholdValidationMs.defaultValue,
    min: 3_600_000,
    unit: 'ms',
  },
