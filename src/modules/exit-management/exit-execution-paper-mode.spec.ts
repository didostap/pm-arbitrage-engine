...
// Integration tests: enter via service.evaluatePositions() (ExitMonitorService)
// but assert execution-level paper mode behavior (orders, events, risk calls).
describe('ExitExecutionService — paper mode', () => {
